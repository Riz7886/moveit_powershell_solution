...
function Set-PasswordExpirationPolicy {
    Write-Host ""
    Write-Host "==========================================================" -ForegroundColor Yellow
    Write-Host "  SET PASSWORD EXPIRATION POLICY" -ForegroundColor Yellow
    Write-Host "==========================================================" -ForegroundColor Yellow
    Write-Host ""
    Write-Host "This will configure the tenant password policy to:" -ForegroundColor White
    ...
    $confirm = Read-Host "Type YES to set password policy"
    ...
    try {
        ...
        Write-Host ""
        Write-Host "Setting password policy..." -ForegroundColor Yellow
        
        # Get current domain
        $domains = Get-MgDomain
        $primaryDomain = $domains | Where-Object { $_.IsDefault -eq $true }
        
        Write-Host "Primary Domain: $($primaryDomain.Id)" -ForegroundColor Cyan
        Write-Host ""
        Write-Host "Password policy must be set via Microsoft 365 Admin Center:" -ForegroundColor Yellow
        Write-Host ""
        Write-Host "1. Go to: https://admin.microsoft.com" -ForegroundColor White
        Write-Host "2. Settings > Org settings > Security & privacy" -ForegroundColor White
        Write-Host "3. Password expiration policy" -ForegroundColor White
        Write-Host "4. Set passwords to expire after 90 days" -ForegroundColor White
        Write-Host "5. Set notification to 14 days before" -ForegroundColor White
        Write-Host ""
