...
Write-Host "Monitors Created: $monitorCount" -ForegroundColor Green
Write-Host ""
Write-Host "View monitors: https://$DD_SITE.datadoghq.com/monitors/manage" -ForegroundColor Cyan
Write-Host ""
Write-Host "Monitors will show GREEN in 10 minutes" -ForegroundColor Yellow
Write-Host ""
Write-Host "To run on another subscription: Run this script again" -ForegroundColor Yellow
Write-Host ""
