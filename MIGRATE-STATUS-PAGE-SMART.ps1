...
# Build SCM URL from default hostname (handles new Azure URL format)
# Example: pyxhealthfowarding-f7hge7emergyccds.canadacentral-01.azurewebsites.net
# Becomes: pyxhealthfowarding-f7hge7emergyccds.scm.canadacentral-01.azurewebsites.net
