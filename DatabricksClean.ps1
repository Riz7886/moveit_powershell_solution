...
<tr><td>Service Principal Added</td><td>$status</td></tr>
<tr><td>Groups Configured</td><td>$groups</td></tr>
</table>
<p><strong>Users Configured:</strong></p>
<ul>$userList</ul>
...
<table>
<tr><th>Group Name</th><th>Purpose</th></tr>
<tr><td>admins</td><td>Administrative access group</td></tr>
<tr><td>prod-datateam</td><td>Production data team group</td></tr>
</table>

<h2>Summary</h2>
<p><strong>Total Workspaces:</strong> $($results.Count)</p>
<p><strong>Total Users:</strong> $($TeamMembers.Count)</p>
<p><strong>Service Principal:</strong> $ServicePrincipalName</p>
