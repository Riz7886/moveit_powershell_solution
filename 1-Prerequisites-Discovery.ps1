# ================================================================
# MOVEIT DEPLOYMENT - SCRIPT 1 OF 7
# PREREQUISITES AND NETWORK DISCOVERY
# ================================================================

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "  SCRIPT 1 OF 7: PREREQUISITES & DISCOVERY" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  Custom Domain:    $($global:config.CustomDomain)" -ForegroundColor White
Write-Host "  Key Vault:        $($global:config.KeyVaultName)" -ForegroundColor White
Write-Host ""
