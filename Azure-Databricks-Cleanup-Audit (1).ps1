...
if ($totalOrphaned -gt 0) {
    $summarySection = @"
<div class='danger'>
<h2 style='margin-top:0;border:none;'>WARNING - Cleanup Opportunities Found</h2>
...
<p><strong>WARNING:</strong> Always verify the resource group contents before deletion!</p>
</div>
"@
}
...
<p>Review these resources manually to determine if they are still needed.</p>
<table>
<tr>
<th>Resource Name</th>
<th>Type</th>
...
<div class="metric"><strong>$wsCount</strong><span>Active Workspaces</span></div>
<div class="metric"><strong>$mgdRGCount</strong><span>Managed Resource Groups</span></div>
<div class="metric"><strong style="color:#dc3545;">$totalOrphaned</strong><span>Orphaned Resources</span></div>
<div class="metric"><strong>$otherCount</strong><span>Other Resources</span></div>
</div>
</div>
...
<ul>
<li><strong>All $wsCount active Databricks workspaces</strong></li>
<li><strong>All $mgdRGCount managed resource groups</strong> linked to active workspaces</li>
...
<strong>Subscription:</strong> $subName
</p>
