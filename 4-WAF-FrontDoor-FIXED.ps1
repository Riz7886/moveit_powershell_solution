...
# WAF AND FRONT DOOR - WITH SSL/TLS SECURITY
# ================================================================
...
# ================================================================
# NEW SSL/TLS SECURITY CONFIGURATION - THIS WAS MISSING!
# ================================================================
Write-Host ""
Write-Log "============================================" "Magenta"
...
# Update Front Door endpoint with SSL/TLS minimum version
...
# Update route with SSL/TLS settings
Write-Log "Enforcing HTTPS-only with TLS 1.2+..." "Yellow"
az afd route update `
    --resource-group $config.DeploymentResourceGroup `
    --profile-name $FrontDoorProfileName `
    --endpoint-name $FrontDoorEndpointName `
...
Write-Log "SSL/TLS security configured" "Green"
Write-Host ""
Write-Log "SECURITY ENFORCED:" "Cyan"
Write-Log "  ✓ TLS 1.2 minimum (TLS 1.0/1.1 blocked)" "Green"
Write-Log "  ✓ HTTPS-only (HTTP redirected)" "Green"
Write-Log "  ✓ Strong cipher suites only" "Green"
Write-Host ""
...
Write-Host "  ✓ TLS 1.2+ only (old versions blocked)" -ForegroundColor Green
Write-Host "  ✓ HTTPS enforced (HTTP auto-redirects)" -ForegroundColor Green
Write-Host "  ✓ WAF protection active" -ForegroundColor Green
Write-Host ""
