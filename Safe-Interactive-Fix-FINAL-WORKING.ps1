...
# EXACT COPY FROM AUDIT SCRIPT - Line 121-131
...
try {
    ...
    Write-Fail "Could not retrieve subscriptions"
    exit 1
}

Write-Host ""
Write-Host "Press ENTER to start scanning ALL subscriptions..." -ForegroundColor Cyan
Read-Host
...
# ================================================================
# SCAN ALL SUBSCRIPTIONS - EXACT COPY FROM AUDIT SCRIPT
# ================================================================

Write-Host ""
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host "SCANNING ALL SUBSCRIPTIONS FOR CRITICAL ISSUES" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""

# EXACT COPY FROM AUDIT SCRIPT - Line 193
foreach ($subscription in $subscriptions) {
    ...
    # ================================================================
    # NSG SCAN - EXACT COPY FROM AUDIT SCRIPT Line 233-266
    # ================================================================
    
    Write-Info "  [NSG] Scanning Network Security Groups..."
    try {
    ...
    # ================================================================
    # STORAGE SCAN - EXACT COPY FROM AUDIT SCRIPT Line 323-343
    # ================================================================
    
    Write-Info "  [STORAGE] Scanning Storage Accounts..."
    try {
            ...
            try {
                ...
                foreach ($container in $containers) {
                    ...
                    if ($container.PublicAccess -ne "Off") {
                        Write-Fail "    FOUND: $($sa.StorageAccountName)/$($container.Name) - Access: $($container.PublicAccess)"
...
Write-Host "================================================================" -ForegroundColor Yellow
Write-Host ""
Write-Host "  Dangerous NSG Rules:      $($dangerousRules.Count)" -ForegroundColor $(if ($dangerousRules.Count -gt 0) { "Red" } else { "Green" })
Write-Host "  Public Blob Containers:   $($publicContainers.Count)" -ForegroundColor $(if ($publicContainers.Count -gt 0) { "Red" } else { "Green" })
Write-Host ""

# ================================================================
# PART 1: FIX NSG RULES
# ================================================================
...
if ($dangerousRules.Count -eq 0) {
    ...
    Write-Host "================================================================" -ForegroundColor Cyan
    Write-Host "PART 1: DANGEROUS NSG RULES" -ForegroundColor Cyan
    Write-Host "================================================================" -ForegroundColor Cyan
    Write-Host ""
    ...
    for ($i = 0; $i -lt $dangerousRules.Count; $i++) {
        ...
        Write-Host "$($item.Subscription) " -NoNewline -ForegroundColor Magenta
    ...
    if ($choice -eq "A") {
        ...
        foreach ($item in $dangerousRules) {
            try {
                Write-Host "  [$($item.Subscription)] Deleting: $($item.RuleName) from $($item.NSG)..." -ForegroundColor Yellow
        ...
        foreach ($item in $dangerousRules) {
            ...
            Write-Host "$($item.Subscription)" -ForegroundColor Magenta
            Write-Host "NSG: " -NoNewline
...
Write-Host "Press ENTER to continue to Storage..." -ForegroundColor Cyan
Read-Host
...
if ($publicContainers.Count -eq 0) {
    ...
    Write-Host ""
    Write-Host "================================================================" -ForegroundColor Cyan
    Write-Host "PART 2: PUBLIC BLOB CONTAINERS" -ForegroundColor Cyan
    Write-Host "================================================================" -ForegroundColor Cyan
    Write-Host ""
    ...
    if ($choice -eq "A") {
        ...
        foreach ($group in $accountGroups) {
            ...
            Write-Host "----------------------------------------" -ForegroundColor Gray
            Write-Host "Subscription: " -NoNewline
            Write-Host "$subName" -ForegroundColor Magenta
