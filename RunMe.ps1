...
Write-Host "Starting Databricks to Datadog Integration..." -ForegroundColor Green
...
Write-Host "Creating Databricks alerts..." -ForegroundColor Cyan
...
$dashboard = @{
    title = "Databricks Enterprise Monitoring"
...
Write-Host "Starting metrics ingestion loop..." -ForegroundColor Yellow
