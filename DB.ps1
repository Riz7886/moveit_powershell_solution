...
Write-Log "Found $($workspaces.Count)" "SUCCESS"
...
foreach ($result in $results) {
    ...
    $html += "<p><b>Groups:</b> $($result.GroupsConfigured -join ', ')</p>"
...
$html += "<p>Created by Syed Rizvi</p></body></html>"
